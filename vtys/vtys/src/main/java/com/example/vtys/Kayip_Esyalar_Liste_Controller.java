...
public class Kayip_Esyalar_Liste_Controller {
    @FXML
    ...
    public void initialize() throws SQLException {
        Kayip_Esyalar_Controller k = new Kayip_Esyalar_Controller();
        String sql_sorgu = "EXEC KayipKategoriFiltrele @KategoriID = "+k.getKategori_id() +";";
        ilanEkle(sql_sorgu);
    }
